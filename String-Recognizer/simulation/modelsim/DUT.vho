...
SIGNAL \dut_instance|add_instance|outp\ : std_logic;
...
\datau[0]\ : maxv_lcell
-- Equation(s):
-- datau(0) = DFFEAS((\datau[0]~0_combout\ & (\dut_instance|add_instance|outp\ & ((!\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\)))) # (!\datau[0]~0_combout\ & (((datau(0))))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , , , , , )
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	dataa => \dut_instance|add_instance|outp\,
	datab => datau(0),
...
-- Equation(s):
-- \dut_instance|add_instance|y_present~13\ = (dut_input(4) & ((\dut_instance|add_instance|y_present.s6~regout\ & ((!dut_input[2]))) # (!\dut_instance|add_instance|y_present.s6~regout\ & (\dut_instance|add_instance|y_present.s5~regout\ & dut_input[2]))))
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	dataa => \dut_instance|add_instance|y_present.s5~regout\,
...
-- Equation(s):
-- \dut_instance|add_instance|y_present.s6~regout\ = DFFEAS((!dut_input(1) & (\dut_instance|add_instance|y_present.s6~regout\ $ (((\dut_instance|add_instance|Equal6~0\ & \dut_instance|add_instance|y_present~13\))))), GLOBAL(dut_input(0)), VCC, , , , , , )
...
PORT MAP (
	clk => dut_input(0),
	dataa => dut_input(1),
	datab => \dut_instance|add_instance|Equal6~0\,
...
-- Equation(s):
-- \dut_instance|add_instance|outp\ = (!dut_input(2) & (\dut_instance|add_instance|y_present.s6~regout\ & (dut_input[4] & \dut_instance|add_instance|Equal6~0\)))
-- dut_input(4) = DFFEAS(\dut_instance|add_instance|outp\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	...
	datab => \dut_instance|add_instance|y_present.s6~regout\,
	datac => data(4),
	datad => \dut_instance|add_instance|Equal6~0\,
	aclr => GND,
	sload => VCC,
	ena => \shift_reg~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|outp\,
	regout => dut_input(4));
...
-- Equation(s):
-- \dut_instance|add_instance|Equal1~0\ = ((!dut_input(2) & (!dut_input[5] & dut_input(6))))
...
PORT MAP (
	dataa => dut_input(3),
	datab => dut_input(4),
	datad => \dut_instance|add_instance|Equal1~0\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
PORT MAP (
	dataa => dut_input(3),
	datab => dut_input(4),
	datac => \dut_instance|add_instance|y_present.s1~regout\,
	datad => \dut_instance|add_instance|Equal1~0\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \dut_instance|add_instance|Equal0~0_combout\ = ((\dut_instance|add_instance|Equal6~0\ & (!dut_input(4) & dut_input(2))))
...
-- Equation(s):
-- \dut_instance|add_instance|y_present.rst~regout\ = DFFEAS((!\dut_instance|add_instance|outp\ & (!dut_input(1) & ((\dut_instance|add_instance|Equal0~0_combout\) # (\dut_instance|add_instance|y_present.rst~regout\)))), GLOBAL(dut_input(0)), VCC, , , , , , )
...
PORT MAP (
	...
	datab => \dut_instance|add_instance|y_present.rst~regout\,
	datac => \dut_instance|add_instance|outp\,
	datad => dut_input(1),
	aclr => GND,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \dut_instance|add_instance|y_present.s1~regout\ = DFFEAS((!dut_input(1) & ((\dut_instance|add_instance|y_present~21_combout\) # ((!\dut_instance|add_instance|y_present.rst~regout\ & \dut_instance|add_instance|Equal0~0_combout\)))), GLOBAL(dut_input(0)), 
-- VCC, , , , , , )
...
-- Equation(s):
-- \dut_instance|add_instance|y_present~19_combout\ = (dut_input(3) & (!dut_input(4) & (\dut_instance|add_instance|y_present.s1~regout\ & \dut_instance|add_instance|Equal1~0\)))
...
PORT MAP (
	...
	datab => \dut_instance|add_instance|y_present~19_combout\,
...
PORT MAP (
	dataa => dut_input(3),
	datab => dut_input(4),
	datac => \dut_instance|add_instance|y_present.s3~regout\,
	datad => \dut_instance|add_instance|Equal1~0\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \dut_instance|add_instance|y_present~24_combout\ = (!dut_input(3) & (!dut_input(4) & (\dut_instance|add_instance|y_present.s3~regout\ & \dut_instance|add_instance|Equal1~0\)))
...
PORT MAP (
	dataa => dut_input(4),
	datab => \dut_instance|add_instance|Equal6~0\,
	datac => \dut_instance|add_instance|y_present.s5~regout\,
	datad => dut_input(2),
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- pragma translate_on
PORT MAP (
	datain => \dut_instance|add_instance|outp\,
	oe => VCC,
