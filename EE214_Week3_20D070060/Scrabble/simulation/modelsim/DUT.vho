...
\add_instance|and1|Y\ : maxv_lcell
-- Equation(s):
-- \add_instance|and1|Y~combout\ = (\input_vector~combout\(0) & (!\input_vector~combout\(1) & (\input_vector~combout\(3) $ (!\input_vector~combout\(2))))) # (!\input_vector~combout\(0) & (\input_vector~combout\(1) & (\input_vector~combout\(3) $ 
...
-- pragma translate_on
PORT MAP (
	datain => \add_instance|and1|Y~combout\,
	oe => VCC,
