...
-- Equation(s):
-- \add_instance|l~0_combout\ = ((!\input_vector~combout\(3) & (!\input_vector~combout\(2) & \input_vector~combout\(1))))
...
-- Equation(s):
-- \add_instance|g~0\ = (!\input_vector~combout\(3) & ((\input_vector~combout\(2) & ((B1_y_present.gt) # (!\input_vector~combout\(1)))) # (!\input_vector~combout\(2) & (B1_y_present.gt & !\input_vector~combout\(1)))))
...
-- pragma translate_on
PORT MAP (
	datain => \add_instance|l~0_combout\,
	oe => VCC,
