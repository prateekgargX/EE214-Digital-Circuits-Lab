...
SIGNAL \dut_instance|add_instance|mx0|tm|o2|Y~0\ : std_logic;
SIGNAL \dut_instance|add_instance|mx0|tm|o2|Y~1\ : std_logic;
...
\datau[3]\ : maxv_lcell
-- Equation(s):
-- datau(3) = DFFEAS((\shift_reg~2_combout\ & (((\dut_instance|add_instance|mx0|tm|o2|Y~1\)))) # (!\shift_reg~2_combout\ & (datau(3) & ((!\shift_reg~3_combout\)))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , , , , , )
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	dataa => datau(3),
	datab => \dut_instance|add_instance|mx0|tm|o2|Y~1\,
...
-- Equation(s):
-- \dut_instance|add_instance|mx0|tm|o2|Y~0\ = (dut_input(0) & (((dut_input[9]) # (dut_input(1))))) # (!dut_input(0) & (dut_input(5) & ((!dut_input(1)))))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|mx0|tm|o2|Y~0\,
	regout => dut_input(9));

-- Location: LC_X5_Y4_N1
\dut_input[13]\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|mx0|tm|o2|Y~1\ = (\dut_instance|add_instance|mx0|tm|o2|Y~0\ & ((dut_input(17)) # ((!dut_input(1))))) # (!\dut_instance|add_instance|mx0|tm|o2|Y~0\ & (((dut_input[13] & dut_input(1)))))
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	dataa => dut_input(17),
	datab => \dut_instance|add_instance|mx0|tm|o2|Y~0\,
	datac => data(13),
	datad => dut_input(1),
	aclr => GND,
	sload => VCC,
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|mx0|tm|o2|Y~1\,
	regout => dut_input(13));
...
-- pragma translate_on
PORT MAP (
	datain => \dut_instance|add_instance|mx0|tm|o2|Y~1\,
	oe => VCC,
