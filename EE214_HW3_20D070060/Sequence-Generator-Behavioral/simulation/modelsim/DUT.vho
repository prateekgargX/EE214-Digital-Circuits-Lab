...
SIGNAL \dut_instance|add_instance|state\ : std_logic_vector(3 DOWNTO 0);
...
-- Equation(s):
-- \dut_instance|add_instance|state\(1) = DFFEAS((((!\dut_instance|add_instance|state\(1)))), GLOBAL(dut_input(0)), !dut_input(1), , , , , , )
...
-- Equation(s):
-- \dut_instance|add_instance|state\(2) = DFFEAS(\dut_instance|add_instance|state\(1) $ ((((\dut_instance|add_instance|state\(2))))), GLOBAL(dut_input(0)), !dut_input(1), , , , , , )
...
PORT MAP (
	clk => dut_input(0),
	dataa => \dut_instance|add_instance|state\(1),
...
\datau[3]\ : maxv_lcell
-- Equation(s):
-- datau(3) = DFFEAS((\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_cdr~0_combout\ & (\io~regout\ & (\dut_instance|add_instance|state\(3) & !\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\))), 
...
PORT MAP (
	...
	datab => \io~regout\,
	datac => \dut_instance|add_instance|state\(3),
...
\datau[2]\ : maxv_lcell
-- Equation(s):
-- datau(2) = DFFEAS(((\shift_reg~2_combout\ & (\dut_instance|add_instance|state\(2))) # (!\shift_reg~2_combout\ & ((datau(3))))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \datau[0]~1_combout\, , , , )
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	dataa => \dut_instance|add_instance|state\(2),
	datac => datau(3),
...
\datau[0]\ : maxv_lcell
-- Equation(s):
-- datau(0) = DFFEAS((datau(1)) # ((\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_cdr~0_combout\ & (\io~regout\ & !\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \datau[0]~1_combout\, , , , )
...
\dut_instance|add_instance|state[3]\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|state\(3) = DFFEAS((\dut_instance|add_instance|state\(3) $ (((\dut_instance|add_instance|state\(1) & \dut_instance|add_instance|state\(2))))), GLOBAL(dut_input(0)), !dut_input(1), , , , , , )
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \dut_instance|add_instance|state\(3));
...
-- pragma translate_on
PORT MAP (
	datain => \dut_instance|add_instance|state\(3),
	oe => VCC,
