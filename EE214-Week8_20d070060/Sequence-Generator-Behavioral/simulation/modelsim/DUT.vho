...
SIGNAL \dut_instance|add_instance|state\ : std_logic_vector(2 DOWNTO 0);
...
SIGNAL \dut_instance|add_instance|ALT_INV_state\ : std_logic_vector(2 DOWNTO 2);
...
\dut_instance|add_instance|ALT_INV_state\(2) <= NOT \dut_instance|add_instance|state\(2);
...
\datau[2]\ : maxv_lcell
-- Equation(s):
-- datau(2) = DFFEAS((\shift_reg~2_combout\ & (((!\dut_instance|add_instance|state\(2))))) # (!\shift_reg~2_combout\ & (!\shift_reg~3_combout\ & (datau(2)))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , , , , , )
...
PORT MAP (
	...
	datac => datau(2),
	datad => \dut_instance|add_instance|state\(2),
	aclr => GND,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => datau(2));
...
\dut_instance|add_instance|state[0]\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|state\(0) = DFFEAS(((\dut_instance|add_instance|state\(2) & (\dut_instance|add_instance|state\(0))) # (!\dut_instance|add_instance|state\(2) & ((!\dut_instance|add_instance|state\(1))))), GLOBAL(dut_input(0)), !dut_input(1), , , 
-- , , , )
...
PORT MAP (
	clk => dut_input(0),
	dataa => \dut_instance|add_instance|state\(0),
	datac => \dut_instance|add_instance|state\(2),
	datad => \dut_instance|add_instance|state\(1),
	aclr => dut_input(1),
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \dut_instance|add_instance|state\(0));

-- Location: LC_X16_Y10_N9
\dut_instance|add_instance|state[1]\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|state\(1) = DFFEAS(((\dut_instance|add_instance|state\(2) & ((!\dut_instance|add_instance|state\(1)))) # (!\dut_instance|add_instance|state\(2) & (\dut_instance|add_instance|state\(0)))), GLOBAL(dut_input(0)), !dut_input(1), , , 
-- , , , )
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \dut_instance|add_instance|state\(1));
...
\datau[1]\ : maxv_lcell
-- Equation(s):
-- datau(1) = DFFEAS((\shift_reg~2_combout\ & (((!\dut_instance|add_instance|state\(1))))) # (!\shift_reg~2_combout\ & (((datau(2))))), 
...
\datau[0]\ : maxv_lcell
-- Equation(s):
-- datau(0) = DFFEAS((\shift_reg~2_combout\ & (((\dut_instance|add_instance|state\(0))))) # (!\shift_reg~2_combout\ & (((datau(1))))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \datau[0]~1_combout\, , , , )
...
PORT MAP (
	...
	dataa => \shift_reg~2_combout\,
	datac => datau(1),
	datad => \dut_instance|add_instance|state\(0),
	aclr => GND,
	ena => \datau[0]~1_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
\dut_instance|add_instance|state[2]\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|state\(2) = DFFEAS(\dut_instance|add_instance|state\(0) $ (((\dut_instance|add_instance|state\(2) $ (\dut_instance|add_instance|state\(1))))), GLOBAL(dut_input(0)), !dut_input(1), , , , , , )
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \dut_instance|add_instance|state\(2));
...
-- pragma translate_on
PORT MAP (
	datain => \dut_instance|add_instance|ALT_INV_state\(2),
	oe => VCC,
